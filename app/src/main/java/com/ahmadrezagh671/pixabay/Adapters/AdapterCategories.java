...
public class AdapterCategories extends RecyclerView.Adapter<AdapterCategories.ViewHolder> {
    ...
    public AdapterCategories(List<Category> categories, Context context, Activity activity, FragmentExplore fragmentExplore) {
    ...
    public void onBindViewHolder(@NonNull AdapterCategories.ViewHolder holder, int position) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fragmentExplore.setCategory(capitalizeFirstLetter(item.getName()));
